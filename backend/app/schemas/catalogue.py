...
class CatalogueItemBase(BaseModel):
    ...
    shipping_price_expedited: Decimal = Field(..., description="Expedited shipping price")
...
class CatalogueItemCreate(CatalogueItemBase):
    images: Optional[List[ItemImageCreate]] = Field(default_factory=list, description="Item images")
